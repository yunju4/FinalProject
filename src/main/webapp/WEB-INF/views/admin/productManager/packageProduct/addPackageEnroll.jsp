    ...
    <div id="layoutSidenav_content" align="center">
      <main>
          <div class="container-fluid px-4">
            <form action="addPackage.ad" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                      <table>
                          ...
                          <tr class="ttt">
                            <th>상품명</th>
                            <td>
                              <input type="text" name="packageName" style="width:100%;">
                            </td>
                          </tr>
                          <tr class="ttt">
                            <th>상품가격</th>
                            <td>
                              <input type="number" name="packagePrice" style="width:100%;">
                            </td>
                          </tr>
                          <tr class="ttt">
								<th>상품 이미지</th>
