...
<%@ include file="../../../common/sidevar.jsp" %>
	...
	<div class="body" style="width: 80%; height: auto; overflow: hidden; margin-left:13%;">
		...
		<div class="cbody body-content"
			...
			<div id="layoutSidenav_content" align="center">
				<div class="container-fluid px-4">
					<form action="addSelf.ad" method="post" enctype="multipart/form-data">
						...
						<div class="card mb-4" style="width: 100%;">
							...
							<div class="card-body">
								<table>
									<tr class="ttt">
										<th>카테고리</th>
										<td><select name="categoryNum" style="width: 100%;">
									...
									<tr class="ttt">
										<th>상품명</th>
										<td><input type="text" name="sideName"
