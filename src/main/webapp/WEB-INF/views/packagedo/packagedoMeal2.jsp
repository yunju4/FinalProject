...
<body>
	...
	<form action="meal2.do" method="post">
                        ...
                        <div class="product__details__pic" >
                            <div class="product__details__pic__item">
                                <img class="product__details__pic__item--large" 
                                    src="../resources/img/채식주의.jpg" height="500px" style="border-radius: 20px;" alt="">
                            </div>
                          ...
                          <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__tab__desc" style="text-align:center;">
                                    <img src="../resources/img/채식주의1.PNG" style="width: 60%;"/>
                                    <img src="../resources/img/채식주의2.PNG" style="width: 60%;"/>
                                    <img src="../resources/img/채식주의3.PNG" style="width: 60%;"/>
                                </div>
                            </div>
