...
<div id="header">
    ...
    <form action="meal4.do" method="post">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="../resources/img/단백질.jpg" height="500px" style="border-radius: 20px;" alt="">
                        </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab"
                                    aria-selected="true">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;패키지 정보</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab"
                                    aria-selected="false">단백질 정보</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__tab__desc" style="text-align:center;">
                                    <img src="../resources/img/단백질1.PNG" style="width: 60%;"/>
                                    <img src="../resources/img/단백질2.PNG" style="width: 60%;"/>
                                    <img src="../resources/img/단백질3.PNG" style="width: 60%;"/>
                                </div>
                            </div>
